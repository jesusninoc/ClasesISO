...
for($numero = 0 ; $numero -lt (Get-Process | select id | sort id)[-1].id; $numero = $numero+2)
{
    $proceso = (Get-Process -Id $numero)
    New-Item -name $proceso.name -ItemType Directory
    Set-Location $proceso.Name
    $proceso | Out-File informacion.txt
    cd C:\Users\LHR\prueba333 
}
```
