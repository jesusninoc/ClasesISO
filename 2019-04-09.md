...
### Registrar un evento (almacenar la dirección IP de la conexión del cliente o del servidor) cuando se logre realizar una conexión con un servidor mediante UDP
