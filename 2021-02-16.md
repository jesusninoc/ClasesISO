...
# Repasar la conexión de carpetas compartidas

-----------

# Almacenamiento (discos, carpetas compartidas, etc.)
...
# Ejercicio
## -Copiar el contenido de todas las carpetas compartidas que tengas en la red a una carpeta (mapear la carpeta compartida con localhost)
