...
# Definiciones
- Nucleo: componente más interno del sistema operativo que actúa como interfaz entre el hardware y el software, gestionando los recursos de la computadora y facilitando la ejecución de procesos.
