...
- Enviar credenciales (Get- Credential) mediante el protocolo UDP entre dos un cliente y un servidor https://www.jesusninoc.com/04/14/enviar-credenciales-get-credential-mediante-el-protocolo-udp-entre-dos-un-cliente-y-un-servidor/
