...
sudo umount /dev/sdb
```
- El primer sector de la primera partición suele ser el 2048 porque las herramientas modernas como fdisk intentan alinear las particiones a 1 MiB para que el disco trabaje de forma más eficiente: si cada sector es de 512 bytes, entonces 1 MiB = 1 048 576 bytes, y 1 048 576 / 512 = 2048 sectores; empezar en ese sector hace que la partición quede alineada con los bloques físicos internos de discos modernos (SSD, discos de 4K, RAID…), evitando accesos “descuadrados” y mejorando el rendimiento.
